export const hero = {
  ...
  description:
    "Clientes já pesquisam em ChatGPT, Gemini, Perplexity e Google com IA. A KORA prepara sua empresa para ser encontrada, compreendida e considerada nesse novo ambiente de busca.",
